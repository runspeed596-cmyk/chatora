...
import com.chatora.app.data.remote.ApiService
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map
import com.chatora.app.data.local.TokenManager
import com.chatora.app.data.remote.LoginRequest
import com.chatora.app.data.remote.UserDto
...
class UserRepositoryImpl @Inject constructor(
    ...
    private suspend fun saveUser(body: UserDto?) {
        if (body != null) {
            val country = com.chatora.app.data.StaticData.getCountries().find { it.code == body.countryCode }
            val user = UserEntity(
                ...
                countryNameRes = country?.nameRes ?: com.chatora.app.R.string.select_country,
